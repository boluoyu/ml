...
INDEX_NAME_CLASS_MAP = {0: "negative", 1: "positive", 3: "neutral"}
NAME_INDEX_CLAS_MAP = {"negative": 0, "positive": 1, "neutral": 2}


def get_training_data(text_data_dir):
    with open(text_data_dir) as f:
        return [Sample(sample['text'], NAME_INDEX_CLAS_MAP[sample["airline_sentiment"]])
